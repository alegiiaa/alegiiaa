...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=18&pause=1200&color=A371F7&center=true&vCenter=true&width=620&height=50&lines=Industrial+Engineer+who+ships+real+products;1st+Place+%40+Misk+x+Uber+Mobility+Hackathon;Co-Founder+%40+Shater+-+8000%2B+users+in+2+months;I+engineer+systems.+I+build+products.+I+ship.)](https://github.com/alegiiaa)
...
awards  : [ 1st Place Misk × Uber Hackathon, Industrithon Finalist, 3rd Place NewTech ]
focus   : [ AI, Computer Vision, Data-Driven Automation, Systems Thinking ]
stack   : [ Flutter, React, Next.js, Python, Swift, AWS, PostgreSQL ]
```
...
**🚀 [Shater](https://github.com/alegiiaa/ShaterWebsite)**
Co-founded a student productivity app — **8,000+ users in 2 months**.
752K+ organic TikTok views · retention 4% → 11% · 1% paywall conversion.

`Flutter` `Dart` `PostHog` `PostgreSQL` `Growth`

</td>
<td width="50%" valign="top">

**🏆 Misk × Uber Mobility API**
**1st Place** — built a custom API for Uber's mobility platform in 24h.
Uber reps requested follow-up to explore real-world integration.

`API Design` `System Architecture` `Prototyping`
...
**🧠 [AI Drowsiness Detection](https://github.com/alegiiaa/Drowsiness-Detector)**
Real-time CV system — **95% true-positive**, 87% fewer false positives.
Custom Eye-Aspect-Ratio scoring with MediaPipe + OpenCV.
...
**🅿️ No Traffic**
Technical Lead — architected the admin platform powering valet ops
across UBT University, The Vue, Mangrove & Prestige Mall.

`Full-Stack` `System Design` `Operations`
...
**🎮 [mix-and-make](https://github.com/alegiiaa/mix-and-make)**
Bilingual EN/AR Kahoot-style web game for Manufacturing Club Rabigh.
...
**📊 [saded](https://github.com/alegiiaa/saded)**
Fully-functional MVP built for the SADAIA × GASTAT Hackathon.

`TypeScript` `React` `Data`
...
**[→ View all projects](https://github.com/alegiiaa?tab=repositories)**
...
[![trophy](https://github-profile-trophy.vercel.app/?username=alegiiaa&theme=onedark&no-frame=true&no-bg=true&margin-w=8&margin-h=8&column=7)](https://github.com/alegiiaa)
...
[![GitHub Streak](https://streak-stats.demolab.com?user=alegiiaa&hide_border=true&background=0D1117&border=30363D&stroke=A371F7&ring=A371F7&fire=A371F7&currStreakNum=C9D1D9&currStreakLabel=A371F7&sideNums=C9D1D9&sideLabels=C9D1D9&dates=8B949E&dayLabels=A371F7)](https://git.io/streak-stats)
